...
public class TorrentSdk {
    /**
     ...
     - Parameter settingsPack: The default settings pack to init torrent engine.
     */
    public static func initEngine(downloadFolder: String, configFolder: String, settingsPack: SettingsPack) {
        ...
        let settingsPackRaw = settingsPack.asNative()
    ...
    /**
     ...
     - Parameter settingsPack: Settings pack to apply to torrent engine.
     */
    public static func applySettingsPack(settingsPack: SettingsPack) {
        let settingsPackRaw = settingsPack.asNative()
        apply_settings_pack(settingsPackRaw)
        free_settings_pack(settingsPackRaw)
    }
